...
If you ever want to automate this properly (a scheduled job, say) where being asked for a password every time isn't practical, pull it from an environment variable instead. Just don't ever go back to hardcoding it in the file.
